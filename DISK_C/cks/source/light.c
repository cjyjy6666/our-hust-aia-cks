...
void draw_light_page()
{
	...
	//双闪（不对）
	Line3(316,63,266,150,2,0x0000FF);
	Line3(316,63,366,150,2,0x0000FF);
	Line3(266,150,366,150,2,0x0000FF);
	Line2(316,53,275,145,0x0000FF);
	Line2(316,53,357,145,0x0000FF);
	Line2(275,145,357,145,0x0000FF);
}